...
import { useNEPAWorldModel } from "@/shared/hooks/useNEPAWorldModel";
import { useAIBlueprint } from "@/shared/hooks/useAIBlueprint";
import type { DifficultyLevel, MechanicType, MiniGameBlueprint, PatientContext, PatientPhonemeInfo } from "@/shared/lib/miniGameBuilder/types";

const ScenePreview = lazy(() => import("@/shared/lib/miniGameBuilder/ScenePreview"));
