  ...
  const sections = [
    {
      ...
      content: t(
        "Speech therapy helps people improve their ability to communicate. A speech therapist (also known as a speech-language pathologist) works with individuals who have difficulties with speech sounds, language, voice, fluency, or swallowing.",
    ...
    },
    {
      ...
      content: t(
        "Common issues include articulation disorders (difficulty producing sounds), phonological disorders (patterns of sound errors), apraxia of speech (motor planning difficulties), stuttering, and voice disorders. In Cantonese speakers, tone production and nasal sound distinctions are frequent areas of focus.",
        "常見問題包括構音障礙（難以發出聲音）、音韻障礙（聲音錯誤模式）、言語失用症（動作計劃困難）、口吃和聲音障礙。在廣東話使用者中，聲調產生和鼻音區分是常見的重點領域。",
        "常见问题包括构音障碍（难以发出声音）、音韵障碍（声音错误模式）、言语失用症（动作计划困难）、口吃和声音障碍。在广东话使用者中，声调产生和鼻音区分是常见的重点领域。",
      ),
    },
    {
      icon: BookOpen,
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">
            {t("Learn about speech therapy and speech development.", "了解言語治療和語言發展。", "了解言语治疗和语言发展。")}
          </p>
        </div>

        {/* Disclaimer */}
        <div className="bg-accent/10 border-2 border-accent/30 rounded-2xl p-4 mb-6 flex gap-3">
