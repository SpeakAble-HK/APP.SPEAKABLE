...
import type { BilabialPhonemeKey } from "@/shared/components/bilabial/bilabialTypes";
import { MatchingGame, type MatchingOption } from "@/shared/components/bilabial/MatchingGame";
import { RecordingModule } from "@/shared/components/bilabial/RecordingModule";
import { AIFeedbackModule } from "@/shared/components/bilabial/AIFeedbackModule";
import { speakWithClonedVoice, generateClonedAudioBlob } from "@/shared/components/bilabial/clonedVoiceTTS";
import { getDemoClip, saveDemoClip } from "@/shared/components/bilabial/demoPipeline";
import { useTherapistCalibration } from "@/adaptation/useTherapistCalibration";
import {
  computeAccuracyFromResult,
  matchingWrongMessage,
  phonemeLabelToKey,
} from "@/shared/components/bilabial/bilabialUtils";
import { BilabialGameHUD } from "@/shared/components/bilabial/BilabialGameHUD";
import { BILABIAL_TARGET_COUNT, useBilabialGameSession } from "@/shared/components/bilabial/useBilabialGameSession";
import { SPEECH_PASS_ACCURACY_THRESHOLD } from "@/shared/lib/speechExerciseRules";
