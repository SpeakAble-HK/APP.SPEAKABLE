        ...
        <CardContent className="p-8">
          {success ? (
            <div className="text-center py-4">
              ...
              <h1 className="text-2xl font-bold text-foreground mb-2">歡迎加入！</h1>
            ...
            <>
              <div className="text-center mb-6">
                ...
                <h1 className="text-2xl font-bold text-foreground">你已獲邀請</h1>
                <p className="text-sm text-muted-foreground mt-1">設定密碼以完成帳號設定。</p>
              </div>
              <form onSubmit={handleSetPassword} className="space-y-4">
                <div className="space-y-1.5">
                  <Label htmlFor="invite-password" className="text-xs font-medium">密碼</Label>
