...
import { usePronunciationAPI, PhonemeResult } from "@/shared/hooks/usePronunciationAPI";
import type { QuestLessonData } from "@/data/questLessons";
import { resolveSpeechLesson } from "@/data/loadSpeechLesson";
import { useSpeechExerciseMachine } from "@/shared/hooks/useSpeechExerciseMachine";
import { adaptPronunciationFeedback, type NormalizedPronunciationFeedback } from "@/shared/lib/pronunciationFeedbackAdapter";
import {
  SPEECH_PASS_ACCURACY_THRESHOLD,
  canContinueToNext,
  nextBestScore,
  shouldOfferRetry,
} from "@/shared/lib/speechExerciseRules";
import { logPronunciationAttempt } from "@/shared/lib/learningAttemptLog";
import { SpeechExerciseShell } from "@/shared/components/speechExercise/SpeechExerciseShell";
