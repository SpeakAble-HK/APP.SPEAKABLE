...
import { BurnedInCaptions } from "./components/BurnedInCaptions";
import captionsSRT from "../public/captions/vo_zh-HK_calibration.srt?raw";

const FPS = 60;
const s = (sec: number) => Math.round(sec * FPS);

export const LipCalibrationWithCaptions: React.FC<{ duration: number; i18n: any; width: number; height: number }> = ({ i18n, width, height }) => {
  return (
    <AbsoluteFill style={{ backgroundColor: "#0B1220", fontFamily: "Noto Sans HK", width, height }}>
      ...
      <BurnedInCaptions srt={captionsSRT} fps={FPS} />
    </AbsoluteFill>
  );
};
